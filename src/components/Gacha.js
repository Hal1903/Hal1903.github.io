...
const items = [
    ...
    {rank: 1, title: "04. Favorite food", desc: "Roast beef, sushi, omelette rice, cream melon soda, etc." },
    {rank: 1, title: "05. The lowest test score", desc: "8/100 (examining the ability to draw straight lines using a ruler.)" },
    {rank: 1, title: "06. Favorite games", desc: "Final Fantasy Tactics Advance, Dragon Quest 11, Puyo Puyo & Tetris, and Japanese indies (including One-Way Heroic)" },
    {rank: 1, title: "07. Three words that describe me the most (subjective)", desc: "curious, coherent, and lazy (good and bad)"},
    {rank: 1, title: "08. Favorite Color in MTG", desc: "Blue and Black. The same in Duel Masters and Vanguard, too." },

    {rank: 2, title: "09. The very first word I learned", desc: "This/これ" },
    ...
    {rank: 2, title: "12. My travel habits", desc: "Going to universities or tech companies nearby and buy some gifts and buy a Starbucks mug if it is a state I have never visited." },
    ...
    {rank: 4, title: "17. Non-stem fields I am interested in", desc: "Logic, Ontology, Phonology, Linguistic, Epistemology, etc." },
    ...
    {rank: 6, title: "20. Favorite ML Models", desc: "Autoencoder, variations of GAN, GNN, and Gaussian Process. Not a model, but dropout regularization is intriguing to me." },
